...
const farcasterManifest = {
  ...
  miniapp: {
    version: "1",
    name: "Basemate",
    iconUrl: "https://app.basemate.app/icon.png",
    homeUrl: "https://app.basemate.app",
    imageUrl: "https://app.basemate.app/txnmate.jpeg",
    buttonTitle: "Open Basemate",
    splashImageUrl: "https://app.basemate.app/splash.png",
    splashBackgroundColor: "#0505FF",
    ...
    ogImageUrl: "https://app.basemate.app/txnmate.jpeg",
    heroImageUrl: "https://app.basemate.app/txnmate.jpeg",
  },
};
